                  ...
                  <div className="sm:w-1/2 md:w-1/2">
                    <div
                      className={`flex sm:w-full md:w-full items-center justify-between gap-5 ${
                        selectedIndex == 0 ? '!text-text_w !bg-secondary ' : 'border border-b-0 '
                      } px-5 py-3.5 sm:px-3 sm:py-1.5 sm:border md:border`}
                    >
                      <Text
                        as="p"
                        size="textlg"
                        className={`font-normal uppercase tracking-[2.00px] whitespace-nowrap sm:w-full sm:text-center ${selectedIndex == 0 ? '!text-text_w' : ''}`}
                      >
                        my account
                      </Text>
                      <BsChevronRight
                        ...
                        height={20}
                        // preview={false}
                        className={`h-[20px] w-[20px] sm:hidden md:hidden ${selectedIndex == 0 ? '!text-text_w' : ''}`}
                      />
                    </div>
                  </div>
                  <div className="sm:w-1/2 md:w-1/2">
                    <div
                      className={`flex sm:w-full md:w-full items-center justify-between gap-5 ${
                        selectedIndex == 1 ? '!text-text_w !bg-secondary' : 'border border-t-0'
                      } px-5 py-3.5 sm:px-3 sm:py-1.5 sm:border md:border`}
                    >
                      <Text
                        as="p"
                        size="textlg"
                        className={`font-normal uppercase tracking-[2.00px] whitespace-nowrap sm:w-full sm:text-center ${selectedIndex == 1 ? '!text-text_w' : ''}`}
                      >
                        my purchases
                      </Text>
                      <BsChevronRight
                        ...
                        width={20}
                        height={20}
                        className={`h-[20px] w-[20px] sm:hidden md:hidden ${selectedIndex == 1 ? '!text-text_w' : ''}`}
                      />
                    </div>
                  </div>
                </div>
